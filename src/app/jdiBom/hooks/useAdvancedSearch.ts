...
export const useAdvancedSearch = () => {
  ...
  const fetchPrevRevi = async (productDetails: IProductInfo[]) => {
  ...
  const handleInputChange = async (
    _setFormState: Dispatch<SetStateAction<IFormState>>,
  ) => {
